...
async function test() {
    try {
       ...
       // console.log(threeD)
        ...
        const authBe = new Panoramax(urlbe).login(tokenBe)
        const crocodilesSequence = "1febabae-6643-43d6-b870-5806e1da4970"
        const response = await authBe.changeSequenceProperties(crocodilesSequence, {visibility: "anyone"})
